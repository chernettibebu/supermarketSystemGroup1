                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td><a href="editCatagory.php?U_ID=<?php echo $data['catagory_id'] ?>" class="btn btn-success">Edit</a></td>
                                    <td><a href="delCatagory.php?D_ID=<?php echo $data['catagory_id'] ?>" class="btn btn-danger">Delete</a></td>
                            </tr>
                            <?php
                                    }
                                ?>
